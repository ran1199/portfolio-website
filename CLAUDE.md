...
- **Current phase:** Phase 4 (Case study pages) — Galactic Guardians redesigned visual-first (awaiting Ran's review and OK to publish). Then: ask whether the other three case studies get the visual-first treatment; Ran's GG exports.
